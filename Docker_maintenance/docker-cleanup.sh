...
DRYRUN=0      # DRYRUN is useful in basic day to day run of ansible or terraform. when we run to create a infra or change config of a machine, we need to do a dryrun first and find out what the output will be.
# because during realtime production scenario, we cannot blindly run the commands or scripts
